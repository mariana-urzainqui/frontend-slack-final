...
const SideBar = ({ entorno, canalSeleccionado }) => {
    ...
    const { form_values_state, handleChangeInputValue, clearForm } = useForm({ channelName: '' })
    const { formErrors, validateForm } = useFormValidation(form_values_state, { validateChannelName: true })
    const [formErrorsState, setFormErrorsState] = useState({})
    const [agregarNuevoCanal, setAgregarNuevoCanal] = useState(false)
    const [menuDesplegado, setMenuDesplegado] = useState(false)

    const localChannels = entorno.channels || []
    ...
    const handleAgregarCanal = () => setAgregarNuevoCanal(true)
    ...
    const toggleMenu = () => setMenuDesplegado(!menuDesplegado)

    const handleCanalClick = () => setMenuDesplegado(false)
                        ...
                        <li className="agregar-canal-form">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="botones-formulario">
                                    ...
                                    <button className="cancelar-btn" type="button" onClick={handleCancelar}>
                                        Cancelar
                                    </button>
                                </div>
                            </form>
